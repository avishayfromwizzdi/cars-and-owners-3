...
/** Object Used to Create VehicleToCarOwner */
...
public class VehicleToCarOwnerCreate {
   ...
   * @return VehicleToCarOwnerCreate
   */
  public <T extends VehicleToCarOwnerCreate> T setCarOwner(CarOwner carOwner) {
   ...
   * @return VehicleToCarOwnerCreate
   */
  public <T extends VehicleToCarOwnerCreate> T setCarOwnerId(String carOwnerId) {
   ...
   * @return VehicleToCarOwnerCreate
   */
  public <T extends VehicleToCarOwnerCreate> T setVehicle(Vehicle vehicle) {
   ...
   * @return VehicleToCarOwnerCreate
   */
  public <T extends VehicleToCarOwnerCreate> T setVehicleId(String vehicleId) {
