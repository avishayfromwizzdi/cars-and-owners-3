...
/** Object Used to List VehicleToCarOwner */
...
public class VehicleToCarOwnerFilter {
   ...
   * @return VehicleToCarOwnerFilter
   */
  public <T extends VehicleToCarOwnerFilter> T setCarOwner(List<CarOwner> carOwner) {
   ...
   * @return VehicleToCarOwnerFilter
   */
  public <T extends VehicleToCarOwnerFilter> T setCarOwnerIds(Set<String> carOwnerIds) {
   ...
   * @return VehicleToCarOwnerFilter
   */
  public <T extends VehicleToCarOwnerFilter> T setCurrentPage(Integer currentPage) {
   ...
   * @return VehicleToCarOwnerFilter
   */
  public <T extends VehicleToCarOwnerFilter> T setId(Set<String> id) {
    this.id = id;
    return (T) this;
  }
   ...
   * @return VehicleToCarOwnerFilter
   */
  public <T extends VehicleToCarOwnerFilter> T setPageSize(Integer pageSize) {
   ...
   * @return VehicleToCarOwnerFilter
   */
  public <T extends VehicleToCarOwnerFilter> T setVehicle(List<Vehicle> vehicle) {
   ...
   * @return VehicleToCarOwnerFilter
   */
  public <T extends VehicleToCarOwnerFilter> T setVehicleIds(Set<String> vehicleIds) {
